...
const InjeolmiPool_json_1 = __importDefault(require("./abi/injeolmi-classic/artifacts/contracts/InjeolmiPool.sol/InjeolmiPool.json"));
const Contract_1 = __importDefault(require("./Contract"));
const InjeolmiClassicContract_1 = __importDefault(require("./InjeolmiClassicContract"));
class InjeolmiPoolContract extends Contract_1.default {
    ...
    async swapToKlay(amount) {
        ...
        if (owner !== undefined) {
            if ((await InjeolmiClassicContract_1.default.allowance(owner, this.address)).lt(amount)) {
                await InjeolmiClassicContract_1.default.approve(this.address, amount);
