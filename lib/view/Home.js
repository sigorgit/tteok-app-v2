...
class Home {
    constructor() {
        ...
        })), this.sellResult = (0, skynode_1.el)(".result")), (0, skynode_1.el)(".form", (0, skynode_1.el)("h3", "절미 적금"), (0, skynode_1.el)(".caption", "절미를 넣어두면 수익을 나눠줘서 예치한 절미가 계속 늘어나!"), (0, skynode_1.el)(".caption", "너가 예치한 절미: ", (this.withdrawableDisplay = (0, skynode_1.el)("span.price", "...")), " IJM"), (0, skynode_1.el)(".input-container", this.stakeInput = (0, skynode_1.el)("input", {
        ...
        })), this.sellResult = (0, skynode_1.el)(".result")), (0, skynode_1.el)(".suggest-container", (0, skynode_1.el)("h3", (0, msg_js_1.default)("SUGGEST_TITLE")), (0, skynode_1.el)(".content", (0, skynode_1.el)(".suggest", (0, skynode_1.el)("p", (0, msg_js_1.default)("SUGGEST_DESC1")), (0, skynode_1.el)("button", (0, msg_js_1.default)("SUGGEST_BUTTON1"), {
