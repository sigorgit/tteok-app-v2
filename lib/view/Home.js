...
class Home {
    constructor() {
        ...
        })))), (0, skynode_1.el)(".right-container", (0, skynode_1.el)(".connect-wallet", (0, skynode_1.el)(".caption", "정과 훈훈한 인심의 세계로"), new UserInfo_1.default()), (0, skynode_1.el)(".banner", (0, skynode_1.el)("img", {
