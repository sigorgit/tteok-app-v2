...
class Home {
    constructor() {
        ...
        Layout_1.default.current.content.append((this.container = (0, skynode_1.el)(".home-view", (0, skynode_1.el)("section", (0, skynode_1.el)(".top-banner", (0, skynode_1.el)(".banner-image0"), (0, skynode_1.el)(".banner-image1", (0, skynode_1.el)("img", { src: "/images/injeolmi.png" }), (0, skynode_1.el)("h2", "한국인의 정과 훈훈한 인심"), (0, skynode_1.el)("h1", "떡방앗간.닷컴")), (0, skynode_1.el)("a.banner-image2", {
        ...
        }))), (0, skynode_1.el)(".price-container", (0, skynode_1.el)(".content", (0, skynode_1.el)("h3", "하드포크 물량 받기"), (0, skynode_1.el)("p", "2월 16일까지 받을 수 있음"), (0, skynode_1.el)(".price", (this.hardforkDisplay = (0, skynode_1.el)("span.price", "...")), " IJM"), (0, skynode_1.el)("button", "받기", {
        ...
        })), (0, skynode_1.el)(".content", (0, skynode_1.el)("h3", "연말 이벤트 물량 받기"), (0, skynode_1.el)("p", "1월 23일까지 받을 수 있음"), (0, skynode_1.el)(".price", (this.yearendDisplay = (0, skynode_1.el)("span.price", "...")), " IJM"), (0, skynode_1.el)("button", "받기", {
            ...
            target: "_blank"
        })), (0, skynode_1.el)(".form", (0, skynode_1.el)("h3", "사기"), (0, skynode_1.el)(".caption", (0, skynode_1.el)("a", "클레이스왑", {
        ...
        })), this.buyResult = (0, skynode_1.el)(".result")), (0, skynode_1.el)(".form", (0, skynode_1.el)("h3", "펄기"), (0, skynode_1.el)(".caption", (0, skynode_1.el)("a", "클레이스왑", {
            href: "https://klayswap.com/",
            target: "_blank",
        }), "을 통해 펌"), (0, skynode_1.el)(".caption", "트랜잭션 2번 발생"), (0, skynode_1.el)(".input-container", this.sellInput = (0, skynode_1.el)("input", {
            placeholder: "인절미 수량 입력",
            keyup: () => setTimeout(async () => {
