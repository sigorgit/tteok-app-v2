...
class SparrowNFT {
    constructor() {
        ...
        Layout_1.default.current.content.append(this.container = (0, skynode_1.el)(".sparrow-nft-view", (0, skynode_1.el)(".gnb", (0, skynode_1.el)(".inner-gnb", (0, skynode_1.el)("a", { click: () => ViewUtil_1.default.go("/") }, (0, skynode_1.el)("img", { src: "/images/injeolmi.png", height: "40px" })), (0, skynode_1.el)("h1", "참새 NFT"))), (0, skynode_1.el)("h2", "참새 NFT 목록"), (0, skynode_1.el)("button", "NFT 만들기", {
            click: () => ViewUtil_1.default.go("/sparrow-nft/add")
        }), (0, skynode_1.el)("button.outline", "참새 NFT 주소", {
    ...
    async loadNFTs() {
        ...
        for (let id = 0; id < current.toNumber(); id += 1) {
            const promise = async (index) => {
                ...
                }), (0, skynode_1.el)(".description", description), (0, skynode_1.el)(".info", (0, skynode_1.el)(".minter", `발행자: ${CommonUtil_1.default.shortenAddress(minter)}`), (0, skynode_1.el)(".totalSupply", `총 발행량: ${totalSupply.toNumber()}`)), minter !== address ? undefined : (0, skynode_1.el)(".reupload", (0, skynode_1.el)("h6", "이미지 재업로드"), (0, skynode_1.el)("input.hidden", {
                    type: "file",
                    change: (event) => {
...
exports.default = SparrowNFT;
//# sourceMappingURL=SparrowNFT.js.map