...
class SparrowCustom {
    constructor(params) {
        ...
        Layout_1.default.current.content.append(this.container = (0, skynode_1.el)(".sparrow-custom-view", (0, skynode_1.el)(".gnb", (0, skynode_1.el)(".inner-gnb", (0, skynode_1.el)("a", { click: () => ViewUtil_1.default.go("/") }, (0, skynode_1.el)("img", { src: "/images/injeolmi.png", height: "40px" })), (0, skynode_1.el)("h1", "참새 커스터마이징"))), (0, skynode_1.el)("p.warning", "자산 사용 허락을 받기 위해 트랜잭션이 두번씩 발생할 수 있음"), (0, skynode_1.el)("p.warning", "말풍선에 특수 문자는 깨질 수 있으니 주의해!!")));
        this.load(parseInt(params.id, 10));
    }
    async load(id) {
        const ment = await SparrowsContract_1.default.ments(id);
        const metadata = (await superagent_1.default.get(`https://api.tteok.org/sparrows/${id}`)).body;
        let preview;
        let input;
        this.container.append((0, skynode_1.el)("h2", "꾸미기 폼"), (0, skynode_1.el)("main", preview = new SparrowPreview_1.default(metadata.attributes, ment), (0, skynode_1.el)(".form", (0, skynode_1.el)(".change-ment", (0, skynode_1.el)("p", "말풍선을 변경하는데는 100 IJM이 필요합니다."), input = (0, skynode_1.el)("input", {
            placeholder: "말풍선 멘트",
            value: ment,
            keyup: () => {
        ...
        })), (0, skynode_1.el)(".change-parts", (0, skynode_1.el)("p", "모습을 변경하는데는 100 IJM이 필요합니다."), ...parts_json_1.default.map((p) => {
            let select;
        ...
        })))), (0, skynode_1.el)("h2", "실제 이미지"), (0, skynode_1.el)(".real", (0, skynode_1.el)("img", { src: metadata.image }), (0, skynode_1.el)(".form", (0, skynode_1.el)("p", "실제 이미지가 달라?"), (0, skynode_1.el)("button", "실제 이미지 재생성", {
            click: async () => {
                await superagent_1.default.get(`https://api.tteok.org/sparrows/${id}/refresh`);
                skyrouter_1.SkyRouter.refresh();
            },
