...
class SparrowItem extends skynode_1.DomNode {
    constructor(id) {
        ...
        }), (0, skynode_1.el)("button.claim-button", "MIX 받기", {
            click: async () => {
                if (await Wallet_1.default.connected() !== true) {
                    await Wallet_1.default.connect();
                }
        ...
        }), (0, skynode_1.el)("button.custom-button", "꾸미기", {
