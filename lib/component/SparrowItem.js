...
class SparrowItem extends skynode_1.DomNode {
    constructor(id) {
        super(".sparrow-item");
        this.id = id;
        this.append((0, skynode_1.el)(".content", this.sparrow = (0, skynode_1.el)(".sparrow", (0, skynode_1.el)("span.id", `#${id}`)), (0, skynode_1.el)(".info", (0, skynode_1.el)("span.title", "쌓인 MIX"), this.mixAmount = (0, skynode_1.el)("span.amount", "Loading...")), (0, skynode_1.el)(".controller", (0, skynode_1.el)("button", "MIX 받기", {
            click: async () => {
