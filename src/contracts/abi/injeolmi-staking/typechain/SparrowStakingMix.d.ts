...
interface SparrowStakingMixInterface extends ethers.utils.Interface {
  functions: {
...
export class SparrowStakingMix extends BaseContract {
  ...
  interface: SparrowStakingMixInterface;
