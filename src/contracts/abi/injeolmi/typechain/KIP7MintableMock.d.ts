...
interface KIP7MintableMockInterface extends ethers.utils.Interface {
  functions: {
...
export class KIP7MintableMock extends BaseContract {
  ...
  interface: KIP7MintableMockInterface;
