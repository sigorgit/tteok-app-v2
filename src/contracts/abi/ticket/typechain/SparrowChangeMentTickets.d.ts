...
interface SparrowChangeMentTicketsInterface extends ethers.utils.Interface {
  functions: {
...
export class SparrowChangeMentTickets extends Contract {
  ...
  interface: SparrowChangeMentTicketsInterface;
