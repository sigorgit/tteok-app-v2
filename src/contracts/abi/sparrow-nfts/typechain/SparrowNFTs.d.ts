...
interface SparrowNFTsInterface extends ethers.utils.Interface {
  functions: {
    ...
    "mint(string,string,string,uint256)": FunctionFragment;
    ...
    "changeInfo(uint256,string,string,string)": FunctionFragment;
    "extnames(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "changeInfo",
    values: [BigNumberish, string, string, string]
  ): string;
  encodeFunctionData(
    functionFragment: "extnames",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "changeInfo", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "extnames", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "descriptions",
    data: BytesLike
  ): Result;
...
export class SparrowNFTs extends Contract {
  ...
  interface: SparrowNFTsInterface;
  ...
  functions: {
    ...
    "mint(string,string,string,uint256)"(
      extname: string,
      title: string,
      description: string,
      amount: BigNumberish,
    ...
    "changeInfo(uint256,string,string,string)"(
      id: BigNumberish,
      extname: string,
      title: string,
      description: string,
    ...
    extnames(arg0: BigNumberish, overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    extnames(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
